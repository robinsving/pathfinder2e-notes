...
| \* Your oracular class feature gives you a 10th-level spell slot that works differently from other spell slots. |  |  |  |  |  |  |  |  |  |  |  |
...
Your curse has the curse, divine, and necromancy traits. You can't mitigate, reduce, or remove the effects of your oracular curse by any means other than Refocusing and resting for 8 hours. For example, if your curse makes creatures [[Concealed]] from you, you can't negate that concealed condition through a magic item or spell, such as _[[Sure Strike]]_ (though you would still benefit from the other effects of that item or spell). Likewise, _[[Cleanse Affliction]]_ and similar spells don't affect your curse at all.
