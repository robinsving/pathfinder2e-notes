...
foundryId: RollTable.WNnvOJyoSlWASvVa
tags:
  - RollTable
draft: true
---
...
| 3 | Donjon. You're imprisoned by a 10th-level <em>[[Imprisonment]]</em> ritual. This uses the prison option, typically sequestering you in a distant part of the world. You also lose all your items. Cease drawing cards. |
| 4 | Dullard. Immediately reduce your Intelligence score by [[/r {1d4+1} #Dullard Intelligence Decrease]]{1d4+1}. You can then draw an additional card, and the Dullard card then disappears forever. |
| 5 | Euryale (curse). A medusa's image curses you with a permanent -1 status penalty to all saving throws. This can be removed by only a deity or the Fates card. [[Effect_ Euryale (Curse) Card\|Effect: Euryale (Curse) Card]] |
...
| 7 | Flames. A fiend becomes filled with anger, jealousy, envy, or some other reason to despise you. Its hatred for you doesn't cease until either it or you is dead. It attacks you or otherwise attempts to foil you within [[/r 1d20 #days]]{1d20 days}. The GM determines the specifics of the fiend. |
| 8 | Fool. You lose [[/r 1d10*100 #XP]]{1d10*100 XP} unless you choose to draw two more cards. |
| 9 | Gem. Gain your choice of 25 pieces of jewelry worth 200 gp each or 50 gems worth 100 gp each. |
| 10 | Jester. You can either draw two more cards or gain [[/r 1d10*100 #XP]]{1d10*100 XP}. The card then disappears forever. |
...
| 13 | Moon. Roll [[/r {1d4} #Wishes]]{1d4} to determine how many wishes the card grants you, which also affects the phase of the moon depicted on the card (1: crescent moon; 2: half moon; 3: gibbous moon; 4: full moon). These wishes each take one action to speak and have the effect of a <em>[[Wish]]</em> spell. |
...
| 20 | Throne. You gain a permanent +4 status bonus to Diplomacy checks, and you now own a small castle in any open area you wish. You must choose its location within 1 hour.  [[Effect_ Throne Card\|Effect: Throne Card]] |
...
| 22 | The Void. Your mind becomes trapped forever. This card is fickle, but it often throws the psyche into a prison in an object on a distant plane or planet. <em>[[Wish]]</em> or similarly powerful magic can reveal your psyche's location, but it doesn't bring you back. Your comatose body continues to function. Cease drawing cards. |
