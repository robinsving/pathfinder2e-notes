---
title: "Beastmaster's Sigil (Major)"
noteType: ":luggage:"
aliases: "Beastmaster's Sigil (Major)"
foundryId: Item.gicXK21SZQ7ieTQG
tags:
  - Item
draft: true
---
...
*   **Ranged Weapon** If you critically hit with the affixed weapon, and the target is adjacent to a creature summoned with the sigil, the target takes 3d6 bleed{3d6 persistent bleed} damage.
...
**Effect** You cast 4th-level _[[Summon Animal]]_ to summon a [[giant-scorpion|Giant Scorpion]] (armor), [[dire-wolf|Dire Wolf]] (melee weapon), or [[fen-mosquito-swarm|Fen Mosquito Swarm]] (ranged weapon).
