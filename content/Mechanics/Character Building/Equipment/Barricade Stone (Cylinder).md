...
noteType: ":luggage:"
aliases: "Barricade Stone (Cylinder)"
foundryId: Item.UjkI9BOGeTRccbP5
tags:
  - Item
draft: true
---
...
You can activate the cylinder horizontally instead of vertically. If you do, the cylinder moves similarly to the _[[Barricade Stone (Sphere)]]_, with the following changes: both DCs increase to 27, the damage increases to 6d6 bludgeoning damage, and a creature that critically fails its Reflex save against the rolling cylinder gains the [[Wounded|Wounded 1]] condition (or increases the value of its wounded condition by 1).
