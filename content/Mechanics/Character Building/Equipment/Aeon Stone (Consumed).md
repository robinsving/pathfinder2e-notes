---
title: Aeon Stone (Consumed)
noteType: ":luggage:"
aliases:
  - Aeon Stone (Consumed)
  - Aeon Stone (Dull Grey)
foundryId: Item.KSX7K1fJKLXigrPN
tags:
  - Item
draft: true
---
...
# Aeon Stone (Consumed)
![[systems-pf2e-icons-equipment-worn-items-other-worn-items-aeon-stone-dull-gray.webp|150]]
...
A _consumed_ aeon stone is a dull lump that has lost its magical properties. It still rotates your head like any other aeon stone and can thus serve as a stylish, hand-free option for various spells that target an object.

This aeon stone has no resonant power.
