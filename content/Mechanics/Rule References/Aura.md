...
**Source** [_Bestiary pg. 342_](https://2e.aonprd.com/Sources.aspx?ID=2)  
...
The GM might determine that a monster's aura doesn't affect its own allies. For example, a creature might be immune to a monster's [frightful presence](https://2e.aonprd.com/MonsterAbilities.aspx?ID=17) if they have been around each other for a long time.