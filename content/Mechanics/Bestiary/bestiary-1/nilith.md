...
abilities_bot:
  - name: "Mind Crush"
    desc: "⬻ ([[enchantment]], [[mental]], [[occult]]); __Requirements__ The nilith has a creature [[grabbed]].  __Effect__  The nilith reaches into the mind of the [[grabbed]] creature and implants disjointed images of the victim's worst fears and nightmares. The [[grabbed]] creature takes 6d6 (6d6) mental damage (DC 31 basic Will save). On a critical failure, the target is also affected as though by feeblemind, and it must attempt a second Will save against that effect."
...
spellcasting:
  - name: "Occult Innate Spells"
    desc: "DC 29; __Cantrips (5th)__ [[Telekinetic Hand]], [[message]], [[read aura]], [[shield]]; __3rd__ [[mind reading]] (at will); __4th__ [[Flicker]], [[confusion]], [[Wave of Despair]], [[dream message]], [[invisibility]] (at will) self only, [[nightmare]]; __5th__ [[hallucination]], [[mind probe]];"
