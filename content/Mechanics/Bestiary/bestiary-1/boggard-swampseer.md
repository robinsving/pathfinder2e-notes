...
languages: "Chthonian, Boggard, Common; "
skills:
  - name: "Skills"
...
abilities_bot:
  - name: "Destructive Croak"
    desc: "⬺ ([[sonic]]);  The swampseer utters a powerful croak that deals 4d6 (4d6) sonic damage to any non-boggard within a 15-foot emanation (DC 19 basic Fortitude save); any creature with the [[frightened]] condition takes additional sonic damage equal to twice the value of their [[frightened]] condition. The boggard can't use."
  - name: "Destructive"
...
spellcasting:
  - name: "Primal Prepared Spells"
    desc: "DC 21, attack +11; __Cantrips (2nd)__ [[acid splash]], [[Light]], [[ray of frost]], [[Tangle Vine]]; __1st__ [[fear]], [[jump]], [[shillelagh]]; __2nd__ [[acid arrow]], [[Mist]];"
