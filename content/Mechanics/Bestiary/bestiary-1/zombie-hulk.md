...
abilities_bot:
  - name: "Corpse Throwing"
    desc: "  A zombie hulk can throw corpses at foes. While any Medium dead body will do, they sometimes throw [[zombie shambler|zombie shamblers]], who take just as much damage from being thrown as the target they hit. A thrown shambler lands [[prone]], but if it's not destroyed, it can rise and use other actions normally."
  - name: "Wide Swing"
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ corpse +17 ([[brutal]], [[range|range increment 30 feet]]); __Damage__ 2d6+9 (2d6+9) bludgeoning"
