...
abilities_bot:
  - name: "Web Lurker Venom"
    desc: " ([[poison]]);  __Saving Throw__ DC 19 Fortitude. __Maximum Duration__ 10 rounds __Stage 1__ 1d6 (1d6) poison and [[flat-footed]] (1 round) __Stage 2__ 1d6 (1d6) poison, [[flat-footed]], and [[slowed|slowed 1]] (1 round)"
  - name: "Web Trap"
    desc: "  A creature hit by the web lurker's web attack is [[immobilized]] and stuck to the nearest surface until it succeeds at DC 20 [[compendium/skills.md#Acrobatics|Acrobatics]] check to [[Escape]]."
