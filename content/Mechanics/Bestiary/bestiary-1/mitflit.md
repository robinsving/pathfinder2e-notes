...
abilities_top:
  ...
  - name: "Vermin Empathy"
    desc: "  Mitflits can use [[compendium/skills.md#Diplomacy|Diplomacy]] to [[Make an Impression]] on and [[Request]] things of arthropods (insects, spiders, scorpions, crabs, and similar invertebrate animals). Most arthropods have a starting attitude of [[indifferent]] to mitflits."
  - name: Items
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ dart +8 ([[agile]], [[range|range increment 20 feet]], [[thrown]]); __Damage__ 1d4-1 (1d4-1) piercing"
