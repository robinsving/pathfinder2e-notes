...
abilities_bot:
  ...
  - name: "Spore Tendrils"
    desc: "⬻  The tendrils that cover the drakauthix's body reach out and infest adjacent creatures, dealing 4d6 (4d6) poison damage and 1d6 (1d6) [[Persistent Damage|persistent poison damage]]. A creature can attempt a basic DC 27 Reflex save to reduce this damage, but one [[grabbed]] by the drakauthix takes a –4 circumstance penalty to this save."
