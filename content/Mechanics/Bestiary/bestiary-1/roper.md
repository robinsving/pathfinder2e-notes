...
abilities_bot:
  - name: "Extend Strands"
    desc: "⬻  The roper extends or retracts six thin, sticky tendrils from its body. While the strands are extended, the roper takes a –4 circumstance penalty to [[compendium/skills.md#Stealth|Stealth]] checks, and while they're retracted, it can't use its strand [[Strike|Strikes]]."
