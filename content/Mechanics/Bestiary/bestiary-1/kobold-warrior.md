...
abilities_bot:
  ...
  - name: "Sneak Attack"
    desc: "  The kobold warrior deals an extra 1d4 (1d4) precision damage to [[flat-footed]] creatures."
abilities_top:
  - name: Items
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ sling +5 ([[propulsive]], [[range|range increment 50 feet]], [[reload|reload 1]]); __Damage__ 1d4 (1d4) bludgeoning"
  - name: Ranged
