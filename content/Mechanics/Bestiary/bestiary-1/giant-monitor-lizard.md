...
abilities_mid:
  - name: "Gnashing Grip"
    desc: "⬲ __Trigger__ A creature [[grabbed]] by the giant monitor lizard's jaws fails a check to [[Escape]]. __Effect__  The giant monitor lizard's jaws deal 1d6 (1d6) piercing damage and the triggering creature is exposed to monitor lizard venom."
abilities_bot:
