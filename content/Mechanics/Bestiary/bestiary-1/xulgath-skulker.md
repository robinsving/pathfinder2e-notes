...
abilities_bot:
  - name: "Hidden Movement"
    desc: "  If a xulgath skulker starts its turn [[undetected]] by a creature or merely [[hidden]] from it, that creature is [[flat-footed]] against the skulker's attacks until the end of the skulker's turn."
  - name: "Sneak Attack"
    desc: "  A xulgath skulker deals an additional 1d6 (1d6) precision damage to [[flat-footed]] creatures."
