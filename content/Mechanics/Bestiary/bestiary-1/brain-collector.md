...
languages: "Chthonian, Aklo, Common, Draconic, Protean, Sakvroth;  telepathy 100 feet;"
skills:
  - name: "Skills"
...
abilities_mid:
  - name: "Brain Blisters"
    desc: "  A brain collector has seven brain blisters on its back that it uses to house stolen brains. A brain collector without all seven blisters full is [[stupefied]] with a value equal to the number of empty blisters."
  - name: "Brain Loss"
...
spellcasting:
  - name: "Occult Spontaneous Spells"
    desc: "DC 26, attack +18; __Cantrips (4th)__ [[Light]], [[detect magic]], [[Telekinetic Hand]], [[prestidigitation]]; __1st__ (4 slots) [[mindlink]], [[ray of enfeeblement]], [[Sure Strike]], [[Phantasmal Minion]]; __2nd__ (4 slots) [[humanoid form]], [[invisibility]], [[mirror image]], [[paranoia]]; __3rd__ (3 slots) [[dispel magic]], [[haste]], [[paralyze]]; __4th__ (2 slots) [[confusion]], [[phantasmal killer]];"
