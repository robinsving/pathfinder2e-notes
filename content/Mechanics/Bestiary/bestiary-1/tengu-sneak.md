...
abilities_bot:
  - name: "Sneak Attack"
    desc: "  The tengu deals 1d6 (1d6) extra precision damage to [[flat-footed]] creatures."
  - name: "Surprise Attacker"
    desc: "  On the first round of combat, creatures that haven't acted yet are [[flat-footed]] to the tengu."
abilities_top:
  - name: Items
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ shortbow +10 ([[deadly|deadly 1d10]], [[range|range increment 60 feet]], [[reload|reload 0]]); __Damage__ 1d6 (1d6) piercing"
