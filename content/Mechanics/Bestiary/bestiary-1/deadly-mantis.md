...
abilities_bot:
  ...
  - name: "Rending Mandibles"
    desc: "⬻  The mantis makes a mandibles [[Strike]] against a creature it has [[grabbed]]. If that [[Strike]] hits and the creature is wearing armor with Hardness 12 or lower, the armor is [[broken]]. This [[Strike]] doesn't further damage armor that's already [[broken]]."
  - name: "Sudden Strike"
    desc: "  On the first round of combat, creatures that haven't acted are [[flat-footed]] to the giant mantis."
