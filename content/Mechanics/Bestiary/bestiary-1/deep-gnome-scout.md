...
abilities_bot:
  - name: "Hidden Movement"
    desc: "  If the deep gnome scout starts its turn [[undetected]] or [[hidden]] to a creature, that creature is [[flat-footed]] against the deep gnome scout's attacks until the end of the turn."
abilities_top:
  - name: Items
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ sling +9 ([[propulsive]], [[range|range increment 50 feet]], [[reload|reload 1]]); __Damage__ 1d6+1 (1d6+1) bludgeoning"
