...
abilities_bot:
  ...
  - name: "Rugged Travel"
    desc: "  A gnoll ignores the first square of [[difficult terrain]] it moves into each time it [[Step|Steps]] or [[Stride|Strides]]."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ composite shortbow +12 ([[deadly|deadly 1d10]], [[propulsive]], [[range|range increment 60 feet]], [[reload|reload 0]]); __Damage__ 1d6+4 (1d6+4) piercing"
