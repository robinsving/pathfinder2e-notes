...
abilities_bot:
  - name: "Jaws"
    desc: "⬻ ([[attack]]); __Requirements__ The zombie has a creature [[grabbed]] or [[restrained]].  __Effect__  The zombie makes a jaws unarmed melee [[Strike]] against the [[grabbed]] or [[restrained]] creature with an attack modifier of +7 that deals 1d8+3 (1d8+3) piercing damage."
