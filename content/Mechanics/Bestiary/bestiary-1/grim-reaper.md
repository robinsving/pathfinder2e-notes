...
abilities_bot:
  ...
  - name: "Energy Drain"
    desc: "  When the grim reaper hits and deals damage with its scythe, it regains 20 Hit Points, and the target must succeed at a DC 43 Fortitude save or become [[doomed|doomed 1]]. If the target is already [[doomed]], the [[doomed]] value increases by 1 (to a maximum of [[doomed|doomed 3]])."
  - name: "Final Death"
...
spellcasting:
  - name: "Divine Innate Spells"
    desc: "DC 47, attack +37; __7th__ [[Interplanar Teleport]]; __10th__ [[finger of death]] (4); __Constant__ __(2nd)__ [[See the Unseen]], __(3rd)__ [[haste]], __(6th)__ [[true seeing]];"
