...
abilities_mid:
  - name: "Traveler's Aura"
    desc: " ([[abjuration]], [[aura]], [[divine]]);  20 feet. Creatures in the astral deva's aura are protected from ambient environmental damage from any plane, including severe and extreme heat and cold as well as more exotic dangers. The astral deva is never [[flat-footed]] to creatures within its aura."
...
spellcasting:
  - name: "Divine Innate Spells"
    desc: "DC 36, attack +28; __Cantrips (7th)__ [[light]]; __1st__ [[detect alignment]] (at will) evil only; __2nd__ [[invisibility]] (at will) self only; __4th__ [[discern lies]] (at will); __7th__ [[blade barrier]], [[divine decree]], [[divine wrath]], [[heal]], [[Cleanse Affliction]], [[remove disease]], [[Clear Mind]]; __Constant__ __(5th)__ [[Truespeech]];"
