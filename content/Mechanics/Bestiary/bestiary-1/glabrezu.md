...
languages: "Chthonian, Empyrean, Draconic;  telepathy 100 feet, tongues;"
skills:
  - name: "Skills"
...
abilities_bot:
  - name: "Captive Rake"
    desc: "⬻ __Requirements__ A creature is [[grabbed]] in the glabrezu's pincer.  __Effect__  The glabrezu pulls the [[grabbed]] creature up to 5 feet closer, then makes two claw [[Strike|Strikes]] against it. Those [[Strike|Strikes]] count as one attack when determining a treachery demon's multiple attack penalty, and the penalty doesn't increase until after both [[Strike|Strikes]]."
...
spellcasting:
  - name: "Divine Innate Spells"
    desc: "DC 34; __Cantrips (7th)__ [[telekinetic projectile]]; __2nd__ [[mirror image]] (at will); __4th__ [[confusion]] (at will), [[Translocate]] (at will); __5th__ [[Translocate]]; __6th__ [[dispel magic]] (at will); __7th__ [[illusory disguise]] (at will), [[reverse gravity]]; __Constant__ __(5th)__ [[Truespeech]], __(6th)__ [[true seeing]];"
