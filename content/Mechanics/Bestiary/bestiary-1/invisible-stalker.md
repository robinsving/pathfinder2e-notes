...
abilities_mid:
  - name: "Naturally Invisible"
    desc: "  The [[invisible]] stalker is [[invisible]] at all times, though when it takes a [[hostile]] action of any kind, it is [[hidden]] instead of [[undetected]] until the start of its next turn, as the vague outline of its humanoid form is faintly visible for a short period of time."
abilities_bot:
  - name: "Sneak Attack"
    desc: "  The [[invisible]] stalker deals 2d6 (2d6) extra precision damage to [[flat-footed]] creatures."
  - name: "Swift Tracker"
    desc: "  The [[invisible]] stalker moves at full Speed while [[Track|Tracking]]."
