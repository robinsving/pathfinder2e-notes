...
abilities_bot:
  ...
  - name: "Predatory Grab"
    desc: "  As [[Grab]], but the jungle drake's [[Grab]] does not end if it moves away. Instead, it carries the [[grabbed]] creature with it. A jungle drake can't [[Fly]] while grabbing a creature unless that creature can also [[Fly]]."
  - name: "Speed Surge"
  ...
  - name: "Woodland Stride"
    desc: "  The jungle drake ignores [[difficult terrain]] and [[difficult terrain|greater difficult terrain]] from non-magical foliage."
