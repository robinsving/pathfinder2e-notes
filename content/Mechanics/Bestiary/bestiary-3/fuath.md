...
abilities_mid:
  - name: "Vulnerable to Sunlight"
    desc: "  A fuath becomes [[drained|drained 1]] (or increases its [[drained]] condition by 1) after every consecutive hour they're exposed to sunlight. Being submerged in more than a foot of water prevents the sunlight from harming the fuath."
abilities_top:
  - name: Items
    desc: "darts (6);"
abilities_bot:
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ dart +9 ([[agile]], [[range|range increment 20 feet]]); __Damage__ 1d4+1 (1d4+1) piercing"
