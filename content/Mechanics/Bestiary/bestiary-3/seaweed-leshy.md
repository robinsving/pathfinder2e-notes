...
languages: "Thalassic, Common, Druidic, Fey;  speak with plants (seaweed only);"
skills:
  - name: "Skills"
...
abilities_bot:
  ...
  - name: "Sea Spray"
    desc: "  A seaweed leshy's water jet has enough salt in it to temporarily impair their target's vision. On a hit, the target must succeed at a DC 20 Fortitude save or be [[dazzled]] for 1 minute or until it spends 3 [[Interact]] actions wiping the salt out of its eyes. On a critical hit, a target that fails its Fortitude save is also [[blinded]] for 1 round."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ water jet +11 ([[range|range increment 30 feet]]); __Damage__ 1d8+4 (1d8+4) bludgeoning plus sea spray"
