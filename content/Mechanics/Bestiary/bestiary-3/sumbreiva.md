...
abilities_mid:
  ...
  - name: "Hunter's Triumph"
    desc: "⬲ ([[auditory]], [[emotion]], [[fear]], [[mental]]); __Trigger__ The sumbreiva kills a creature __Effect__  The sumbreiva lets out a triumphant, bone-chilling howl. Every enemy in a 30-foot emanation must succeed at a DC 36 Will save or become [[frightened|frightened 3]] (and [[fleeing]] as long as it's [[frightened]] on a critical failure)."
abilities_bot:
  - name: "Claim Trophy"
  ...
  - name: "Huntblade Brutality"
    desc: "  The sumbreiva's huntblade deals an additional 2d8 (2d8) damage to [[drained]], [[flat-footed]], or [[frightened]] creatures."
  - name: "Whip Drain"
    desc: "⬻ ([[arcane]], [[death]], [[necromancy]]); __Requirements__ The sumbreiva has a creature [[grabbed]] with their shadow whip  __Effect__  The [[grabbed]] creature must succeed at a DC 38 Fortitude save or become [[drained|drained 2]] ([[drained|drained 3]] on a critical failure). If the creature is already [[drained]], this increases its [[drained]] value instead, to a maximum of [[drained|drained 4]]."
