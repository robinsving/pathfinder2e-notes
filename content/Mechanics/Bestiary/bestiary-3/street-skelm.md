...
abilities_bot:
  ...
  - name: "Frightening Rant"
    desc: "⬻ ([[auditory]], [[concentrate]], [[emotion]], [[enchantment]], [[fear]], [[linguistic]], [[mental]], [[occult]]);  The skelm rants angrily, filling nearby creatures with shame, fear, and anger. Each creature within 30 feet must succeed at a DC 20 Will save or become [[frightened|frightened 1]] ([[frightened|frightened 2]] on a critical failure). While [[frightened]] by this rant, creatures take a –2 status penalty to Strength-based damage rolls against the skelm, but gain a +2 status bonus to those rolls against other creatures."
  - name: "Punishing Strike"
    desc: "⬻  The skelm unleashes his constant rage in a reckless attack that makes him [[flat-footed]] until the start of his next turn. He [[Strike|Strikes]]; if he hits, he increases the number of damage dice by one and adds Push to the effect. This counts as two attacks for his multiple attack penalty."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ rock +9 ([[range|range increment 20 feet]]); __Damage__ 1d6+6 (1d6+6) bludgeoning"
