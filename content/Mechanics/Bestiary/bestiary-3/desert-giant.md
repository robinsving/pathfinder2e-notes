...
abilities_bot:
  - name: "Sand Spin"
    desc: "⬻ __Requirements__ The desert giant is standing in sandy terrain  __Effect__  The desert giant spins around and stirs up loose sand in a 10-foot emanation. Until the beginning of the giant's next turn, creatures in the area are [[concealed]], and other creatures are [[concealed]] to them."
  - name: "Sandwalking"
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ rock +19 ([[brutal]], [[range|range increment 120 feet]]); __Damage__ 2d8+12 (2d8+12) bludgeoning"
