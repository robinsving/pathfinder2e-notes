...
abilities_mid:
  ...
  - name: "Mortic Ferocity"
    desc: "⬲  As Ferocity (page 305), but the lifeleecher is also surrounded by visibly flickering fragments of the souls they've consumed, becoming [[concealed]] until the end of their next turn."
  - name: "Soul Feast"
...
abilities_bot:
  ...
  - name: "Leech Essence"
    desc: " ([[divine]], [[necromancy]]);  When the lifeleecher damages a living or undead creature with their jaws [[Strike]], they drain the target's life essence. The lifeleecher gains 5 temporary Hit Points that last for 1 minute, and the target must succeed at a DC 24 Fortitude save or become [[drained|drained 1]] if living, or [[stunned|stunned 1]] if undead. If the target was already [[drained]] or [[stunned]], the value of this condition instead increases by 1, to a maximum of 3."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ composite shortbow +19 ([[deadly|deadly d10]], [[magical]], [[propulsive]], [[range|range increment 30 feet]]); __Damage__ 2d6+3 (2d6+3) piercing"
