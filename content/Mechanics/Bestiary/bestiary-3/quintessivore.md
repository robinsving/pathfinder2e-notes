...
languages: "Chthonian, Aklo, Common, Infernal, Sakvroth; "
skills:
  - name: "Skills"
...
abilities_bot:
  ...
  - name: "Suspend Soul"
    desc: "⬻ ([[arcane]], [[necromancy]]);  The quintessivore suspends the life processes of a [[dying]] creature within 15 feet of it. The creature can't decrease or increase its HP or [[dying]] value for 10 minutes. The creature can attempt a DC 29 Will save to avoid this effect. If the creature receives magical healing, it can attempt a new save, ending the effect and being healed normally on a success. The effect ends if the quintessivore uses Suspend Soul again."
  - name: "Tattered Soul"
    desc: "  A creature hit by the quintessivore's blade-leg [[Strike]] must succeed at a DC 29 Fortitude save or become [[drained|drained 1]] ([[drained|drained 2]] on a critical failure). If the creature is already [[drained]], it's immune to this effect."
...
spellcasting:
  - name: "Arcane Prepared Spells"
    desc: "DC 29, attack +21; __Cantrips (5th)__ [[daze]], [[detect magic]], [[Telekinetic Hand]], [[ray of frost]], [[read aura]]; __1st__ [[Gentle Landing]], [[fleet step]], [[ray of enfeeblement]]; __2nd__ [[Translate]], [[See the Unseen]], [[web]]; __3rd__ [[slow]], [[Vampiric Feast]] (2); __4th__ [[clairvoyance]], [[enervation]] (2); __5th__ [[black tentacles]], [[grim tendrils]], [[Magic Passage]];"
