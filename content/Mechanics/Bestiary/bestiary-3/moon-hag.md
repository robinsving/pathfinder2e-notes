...
abilities_top:
  - name: "Coven"
    desc: "  A moon hag adds [[Interplanar Teleport]], [[scrying]], and [[spirit blast]] to her [[coven]]'s spells."
abilities_mid:
  - name: "Ferocity"
    desc: "⬲ "
  - name: "Moonlight's Kiss"
    desc: "  A moon hag in an area illuminated by moonlight gains a +2 status bonus to AC and initiative rolls. In the light of a full moon, she is [[quickened]], and can use the extra action only to [[Stride]] or [[Strike]]."
abilities_bot:
