...
abilities_bot:
  ...
  - name: "Shock Mind"
    desc: "⬺ ([[enchantment]], [[mental]], [[occult]]);  The grioth scout makes a [[Strike]] with a voidglass weapon. If the [[Strike]] hits, it deals an additional 2d6 (2d6) mental damage, and the target must succeed at a DC 20 Will save (this has the [[incapacitation]] trait) or become [[confused]] for 1 round."
