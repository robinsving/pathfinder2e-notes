...
languages: "Aklo, Sussuran, Common, Shae, Sakvroth; "
skills:
  - name: "Skills"
...
abilities_mid:
  - name: "Counterattack"
    desc: "⬲ __Requirements__ The shae is aware of the attack __Trigger__ The shae is targeted by an attack from an adjacent creature that misses due to the shae being [[concealed]] __Effect__  The shae makes a [[Strike]] against the attacker."
  - name: "Slip"
...
spellcasting:
  - name: "Occult Innate Spells"
    desc: "DC 21; __Cantrips (2nd)__ [[Void Warp]], [[detect magic]]; __4th__ [[Vapor Form]] (at will); __7th__ [[Interplanar Teleport]] self only; to Shadow Plane or Material Plane only;"
