...
health:
  - name: HP
    desc: "100; [[negative-healing-b2|negative healing]], rejuvenation; __Immunities__ poison, precision, death effects, disease, paralyzed, unconscious; __Resistances__ all damage 5 except force, [[ghost touch]], or positive; double resistance vs. non-magical"
attacks:
  - name: Melee
  ...
  - name: Ranged
    desc: "⬻ ghostly longbow +17 ([[deadly|deadly d10]], [[magical]], [[range|range increment 100 feet]], [[volley|volley 30 feet]]); __Damage__ 1d8+4 (1d8+4) piercing plus 1d8 (1d8) negative"
