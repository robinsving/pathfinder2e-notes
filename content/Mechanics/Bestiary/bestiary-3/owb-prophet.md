...
languages: "Aklo, Caligni, Common, Sakvroth (can't speak any languages);  telepathy;"
skills:
  - name: "Skills"
...
abilities_bot:
  ...
  - name: "Clutching Cold"
    desc: "  A creature hit by the prophet's burning cold [[Strike]] becomes [[immobilized]] in a cluster of binding ice crystals ([[Escape]] DC 31)."
...
spellcasting:
  - name: "Occult Innate Spells"
    desc: "DC 33, attack +25; __Cantrips (7th)__ [[Void Warp]], [[daze]], [[read aura]], [[shield]]; __3rd__ [[mind reading]] (at will); __4th__ [[invisibility]]; __5th__ [[Umbral Journey]] (3) see shadow's swiftness; __6th__ [[darkness]] (at will), [[dominate]] (3); __7th__ [[Interplanar Teleport]] (3), [[shadow blast]] (3);"
