...
abilities_bot:
  - name: "Brutal Blows"
    desc: "  On a critical hit with a fist [[Strike]], the target is knocked [[prone]] by the blow."
  - name: "Forest Stride"
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ rock +9 ([[brutal]], [[range|range increment 30 feet]]); __Damage__ 1d6+5 (1d6+5) bludgeoning"
