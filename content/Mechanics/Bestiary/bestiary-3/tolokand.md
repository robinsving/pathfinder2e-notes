...
abilities_top:
  - name: "Smoke Vision"
    desc: "  Smoke doesn't impair a tolokand's vision; it ignores the [[concealed]] condition from smoke."
abilities_mid:
  - name: "Heartless Furnace"
    desc: " ([[aura]], [[conjuration]], [[occult]]);  50 feet, 2d6 (2d6) poison damage (DC 34 basic Fortitude save). The poisonous smoke that bellows from a tolokand makes all creatures inside it [[concealed]], and all creatures outside the smoke are [[concealed]] to creatures within it."
  - name: "Inexorable"
    desc: "  The tolokand recovers from the [[paralyzed]], [[slowed|slowed 1]], and [[stunned]] conditions at the end of its turn. It's also immune to penalties to its Speeds and ignores [[difficult terrain]] and [[difficult terrain|greater difficult terrain]]."
  - name: "Toxic Blood"
...
spellcasting:
  - name: "Occult Spontaneous Spells"
    desc: "DC 37; __8th__ (3 slots) [[Toxic Cloud]], [[earthquake]], [[Desiccate]], [[volcanic eruption]];"
