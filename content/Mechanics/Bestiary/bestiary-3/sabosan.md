...
abilities_bot:
  - name: "Drain Blood"
    desc: "⬻ __Requirements__ The sabosan has a creature [[grabbed]]  __Effect__  The sabosan drains blood from the creature. The creature must succeed at a DC 23 Fortitude save or become [[drained|drained 1]]. The sabosan gains a number of temporary Hit Points equal to the number of Hit Points lost by the creature."
  - name: "Fell Shriek"
    desc: "⬺ ([[auditory]]);  The sabosan emits a deafening cry in a 30-foot cone. Non-sabosan creatures in this area must each succeed at a DC 23 Fortitude save or be [[deafened]] for 1 minute."
