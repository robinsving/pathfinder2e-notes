...
abilities_bot:
  - name: "Ice Stride"
    desc: "  A wolliped isn't impeded by [[difficult terrain]] caused by snow or ice, nor does it need to attempt [[compendium/skills.md#Acrobatics|Acrobatics]] checks to keep from falling on slippery ice."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ spit +12 ([[range|range increment 30 feet]]); __Damage__ 1d8+2 (1d8+2) bludgeoning"
