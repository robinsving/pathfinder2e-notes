...
abilities_top:
  ...
  - name: "No Hearing"
    desc: "  An akata has no auditory senses. It is immune to [[auditory]] effects, automatically critically fails [[compendium/skills.md#Perception|Perception]] checks that require it to hear, and takes a –2 status penalty to [[compendium/skills.md#Perception|Perception]] checks (but not initiative rolls) that involve sound but also rely on other senses."
abilities_mid:
  - name: "No Breath"
...
abilities_bot:
  - name: "Void Death"
    desc: " ([[disease]]);  __Saving Throw__ DC 17 Fortitude. __Stage 1__ carrier with no ill effect 1 (1 day) __Stage 2__ [[drained|drained 1]] (1 day) __Stage 3__ as stage 2 (1 day) __Stage 4__ [[drained|drained 2]] and [[fatigued]] (1 day) __Stage 5__ as stage 4 (1 day) __Stage 6__ dead and corpse rises as a void zombie (page 288)"
