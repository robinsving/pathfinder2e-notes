...
abilities_bot:
  ...
  - name: "Retract Tongue"
    desc: "⬺  The froghemoth pulls a creature [[grabbed]] by its tongue toward itself. The froghemoth rolls an [[compendium/skills.md#Athletics|Athletics]] check against the creature's Fortitude DC. On a success, the froghemoth pulls the creature into an adjacent space, and if it critically succeeds it can also make a bite [[Strike]] against the creature after the pull."
  - name: "Swallow Whole"
