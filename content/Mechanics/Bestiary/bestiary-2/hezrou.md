...
abilities_mid:
  ...
  - name: "Stench"
    desc: " ([[aura]], [[olfactory]]);  30 feet. A creature entering the aura or starting its turn in the aura must succeed at a DC 27 Fortitude save or become [[sickened|sickened 1]] (plus [[slowed|slowed 1]] for as long as itʼs [[sickened]] on a critical failure). While within the aura, affected creatures take a –2 circumstance penalty to saves against disease and to recover from the [[sickened]] condition. A creature that succeeds at its save is temporarily immune for 1 minute."
abilities_bot:
  - name: "Poisonous Pustules"
    desc: "⬻ ([[poison]]); __Requirements__ The hezrou is grappling a creature  __Effect__  Toxic fluids spurt from burst boils and weeping wens on the hezrou's body. A creature [[grabbed]] or [[restrained]] by the hezrou takes 2d12+6 (2d12+6) poison damage (DC 30 basic Fortitude save)."
...
spellcasting:
  - name: "Divine Innate Spells"
    desc: "DC 27; __4th__ [[Translocate]] (at will), [[divine wrath]] (at will), [[Vapor Form]]; __5th__ [[Abyssal plague]], [[Translocate]]; __6th__ [[divine wrath]], [[paranoia]];"
