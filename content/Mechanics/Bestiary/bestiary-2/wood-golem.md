...
abilities_mid:
  - name: "Golem Antimagic"
    desc: "  harmed by fire (4d8 (4d8), 2d6 (2d6) from areas or [[persistent damage]]); healed by plant (area 2d6 (2d6) HP); [[slowed|slowed 1]] by earth."
  - name: "Vulnerable to Shape Wood"
    desc: "  A wood golem targeted by shape wood takes 2d8 (2d8) damage per spell level, with a basic Fortitude save against the caster's spell DC. On a critical failure, the golem is also [[immobilized]] for 1d4 (1d4) rounds."
  - name: "Splinter"
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ splinter +16 ([[magical]], [[range|range increment 30 feet]]); __Damage__ 2d4+8 (2d4+8) piercing"
