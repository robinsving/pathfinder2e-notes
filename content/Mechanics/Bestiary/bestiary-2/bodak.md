...
abilities_mid:
  - name: "Sunlight Vulnerability"
    desc: "  If exposed to direct sunlight, the bodak can't use actions with the [[death]] trait and it becomes [[slowed|slowed 1]]. The [[slowed|slowed 1]] value increases by 1 each time the bodak ends its turn in sunlight. If the bodak loses all its actions this way, it is destroyed."
...
abilities_bot:
  - name: "Bodak Spawn"
    desc: " ([[necromancy]], [[occult]]);  Any humanoid who dies while [[drained]] or [[doomed]] by a bodak rises as an autonomous bodak 24 hours after its death."
  - name: "Death Gaze"
