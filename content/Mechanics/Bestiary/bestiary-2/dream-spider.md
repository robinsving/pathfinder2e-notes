...
abilities_bot:
  ...
  - name: "Web Trap"
    desc: "  A creature hit by the dream spider's web attack is [[immobilized]] and stuck to the nearest surface until it [[Escape|Escapes]] (DC 16)."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ web +7 ([[range|range increment 10 feet]]); __Damage__ web trap plus dream spider venom"
