...
abilities_bot:
  ...
  - name: "Stunning Chain"
    desc: " ([[incapacitation]]);  If the cornugon critically hits with its spiked chain [[Strike]], the target must succeed at a DC 34 Fortitude save or be [[stunned]] for 1 round (1d4 (1d4) rounds on a critical failure)."
...
spellcasting:
  - name: "Divine Innate Spells"
    desc: "DC 36; __4th__ [[Translocate]] (at will); __5th__ [[Translocate]]; __7th__ [[dispel magic]], [[fireball]] (2), [[lightning bolt]] (2);"
