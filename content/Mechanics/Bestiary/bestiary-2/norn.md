...
languages: "Common, Jotun, Fey;  tongues;"
skills:
  - name: "Skills"
...
abilities_top:
  ...
  - name: "Triumvirate"
    desc: "  This functions as the [[coven]] ability, except only norns can join a triumvirate, and it functions only as long as exactly three norns are part of the triumvirate. A triumvirate grants the following spells: [[alter reality]] (once per day), [[cataclysm]], [[Pinpoint]], [[foresight]], and [[revival]]."
abilities_bot:
  - name: "Fated"
  ...
  - name: "Sever Fate"
    desc: " ([[necromancy]], [[occult]]);  When a norn deals negative damage with a [[Strike]], she regains 10 Hit Points. The target must succeed at a DC 39 Fortitude save or become [[drained|drained 1]] ([[drained|drained 2]] on a critical failure). Further negative damage dealt by the norn increases the [[drained]] condition value by 1 on a failed save (or by 2 on a critical failure), to a maximum of [[drained|drained 4]]."
  - name: "Shift Fate"
...
spellcasting:
  - name: "Occult Innate Spells"
    desc: "DC 42; __7th__ [[dispel magic]] (at will), [[read omens]] (at will), [[spellwrack]] (at will); __8th__ [[Quandary]], [[Migration]]; __9th__ [[power word kill]], [[retrocognition]], [[weird]]; __10th__ [[Freeze Time]]; __Constant__ __(10th)__ [[detect magic]], [[Hidden Mind]], [[Truespeech]], [[true seeing]];"
