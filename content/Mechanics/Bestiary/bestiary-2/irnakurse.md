...
languages: "Chthonian, Elven, Sakvroth (can't speak; "
skills:
  - name: "Skills"
...
abilities_bot:
  ...
  - name: "Sustain Soul"
    desc: "  Scream for up to 6 rounds; each time it does, it repeats the effect.\n__Critical Success__ The creature is unaffected, and is temporarily immune to Soul Scream for 24 hours.\n__Success__ The creature is [[stupefied|stupefied 1]] for 1 round.\n__Failure__ The creature is [[stupefied|stupefied 1]]. Further failed saves against Soul Scream increase the condition value by 1, to a maximum of [[stupefied|stupefied 4]]. Each time the character gets a full night's rest, the [[stupefied]] condition gained from Soul Scream decreases by 1.\n__Critical Failure__ As failure, except the [[stupefied]] value increases by 2 instead of by 1."
