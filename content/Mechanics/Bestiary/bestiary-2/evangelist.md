...
abilities_bot:
  ...
  - name: "Impaling Chain"
    desc: "  When the evangelist critically hits with a chain [[Strike]], the target is impaled and anchored in place, becoming [[grabbed]] by the chain. The creature is unable to recover from [[Persistent Damage|persistent bleed damage]] until it gets free (DC 25 [[Escape]])."
