...
abilities_bot:
  - name: "Piton Pin"
    desc: "⬻ ([[attack]]); __Requirements__ The miner has their hammer in hand  __Effect__  The miner Interacts to draw a piton, then hammers it into a creature to pin them in place, attempting an [[compendium/skills.md#Athletics|Athletics]] check against the target's Reflex DC. On a hit, the target is [[immobilized]] until it removes the piton with a successful DC 10 [[compendium/skills.md#Athletics|Athletics]] check made as an [[Interact]] action."
abilities_top:
  - name: Items
