...
abilities_bot:
  ...
  - name: "Sneak Attack"
    desc: "  The ruffian deals an extra 1d6 (1d6) precision damage to [[flat-footed]] creatures."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ sling +8 ([[propulsive]], [[range|range increment 50 feet]], [[reload|reload 1]]); __Damage__ 1d6+5 (1d6+5) bludgeoning"
  - name: Ranged
