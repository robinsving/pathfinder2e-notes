...
abilities_mid:
  - name: "Deny Advantage"
    desc: "  The burglar isn't [[flat-footed]] to creatures of 4th level or lower that are [[hidden]], [[undetected]], flanking, or using surprise attack."
  - name: "Nimble Dodge"
...
abilities_bot:
  ...
  - name: "Surprise Attack"
    desc: "  On the first round of combat, if the burglar rolls [[compendium/skills.md#Deception|Deception]] or [[compendium/skills.md#Stealth|Stealth]] for initiative, creatures that haven't acted are [[flat-footed]] to them."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ composite shortbow +14 ([[deadly|deadly 1d10]], [[propulsive]], [[range|range increment 60 feet]], [[reload|reload 0]]); __Damage__ 1d6+4 (1d6+4) piercing"
