...
abilities_bot:
  - name: "Hidden Blade"
    desc: "⬻ __Frequency__ once per round  __Effect__  The spy draws a weapon and then [[Strike|Strikes]] with it. The target of the [[Strike]] is [[flat-footed]] against the attack."
  - name: "Sneak Attack"
    desc: "  The spy deals an extra 2d6 (2d6) precision damage to [[flat-footed]] creatures."
