...
abilities_mid:
  - name: "Deny Advantage"
    desc: "  The assassin isn't [[flat-footed]] to creatures of 8th level or lower that are [[hidden]], [[undetected]], flanking, or using surprise attack."
  - name: "Nimble Dodge"
...
abilities_bot:
  ...
  - name: "Sneak Attack"
    desc: "  The assassin deals an extra 2d6 (2d6) precision damage to [[flat-footed]] creatures."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ composite shortbow +20 ([[deadly|deadly 2d10]], [[magical]], [[propulsive]], [[range|range increment 60 feet]], [[reload|reload 0]]); __Damage__ 2d6+4 (2d6+4) piercing"
