...
abilities_top:
  - name: "Focused Thinker"
    desc: "⬻ ([[concentrate]]);  The adept focuses inward to muster knowledge and wisdom. While in this state of concentration, they gain a +2 status bonus to checks to [[Recall Knowledge]], but take a –2 penalty to [[compendium/skills.md#Perception|Perception]]. They can end their focused state with a single action, which has the [[concentrate]] trait."
  - name: Items
...
spellcasting:
  - name: "Occult Spells Known Spells"
    desc: "DC 14; __Cantrips (1st)__ [[daze]], [[detect magic]], [[Telekinetic Hand]];"
