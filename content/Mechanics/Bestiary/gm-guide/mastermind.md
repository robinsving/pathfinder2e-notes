...
abilities_bot:
  - name: "Scoundrel's Feint"
    desc: "  When the mastermind successfully [[Feint|Feints]], the target is [[flat-footed]] against the mastermind's melee attacks until the end of the mastermind's next turn. On a critical success, the target is [[flat-footed]] against all melee attacks for that time, not just the mastermind's."
  - name: "Sneak Attack"
    desc: "  The mastermind deals an extra 1d6 (1d6) precision damage to [[flat-footed]] creatures."
...
attacks:
  ...
  - name: Ranged
    desc: "⬻ hand crossbow +13 ([[range|range increment 60 feet]], [[reload|reload 1]]); __Damage__ 1d6+3 (1d6+3) piercing"
...
spellcasting:
  ...
  - name: "Bard Composition Spells"
    desc: "DC 22; __Cantrips (2nd)__ [[Uplifting Overture]] Core Rulebook 386, [[Courageous Anthem]] Core Rulebook 386;"
