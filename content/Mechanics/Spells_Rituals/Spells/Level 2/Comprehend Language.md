...
description: >
  ...
  &NewLine;**Heightened (3rd)** The target can also speak the language.
  &NewLine;**Heightened (4th)** You can target up to 10 creatures, and targets can also speak the language.
---
# `=this.name`
==divination==
