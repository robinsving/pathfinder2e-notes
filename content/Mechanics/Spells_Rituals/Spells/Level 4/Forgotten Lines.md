...
description: >
  ...
  &NewLine;**Heightened (6th)** The spell reconstructs all missing information regarding a specific topic of your choice.
  &NewLine;**Heightened (9th)** The spell also reveals information the writer self-censored and didn't commit to paper.
---
# `=this.name`
==rare== | ==divination==
