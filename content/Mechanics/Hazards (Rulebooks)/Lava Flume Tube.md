...
***
**Disable** DC 29 thievery (expert) to block a channel, or DC 31 thievery (master) to release the floor latch and escape to the chamber below
___
**Flume Activation** `pf2:r`
**Trigger** A creature tries to leave the room.
**Effect** The exits seal instantly and the trap rolls initiative.
***
**Routine** (4 actions) The trap loses 1 action per disabled channel each turn. On each action, a different channel spews lava, dealing 4d6 fire damage to each creature within 10 feet of the channel (DC 27 reflex), and increasing the depth of the lava in the room by 1 foot (4 feet per round if all the channels are active).
