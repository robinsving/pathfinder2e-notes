...
___
**Lunging Dead** `pf2:r`
#divine #fear #incapacitation #mental 
...
- **Failure:** The target is [[Frightened|Frightened 2]]. It can't reduce its frightened condition below 1 while in the trap's area.
- **Critical Failure:** As failure, and the target is [[Paralyzed]] for 1 round.
***
**Routine** (1 action) Undead fists assail all creatures in the hall, dealing `dice: 4d6` bludgeoning damage. Creatures in the hall must attempt a DC: 21 reflex.
- **Critical Success:** The target is unaffected.
