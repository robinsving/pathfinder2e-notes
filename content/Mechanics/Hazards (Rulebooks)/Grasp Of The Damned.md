...
___
**Mark for Damnation** `pf2:r`
#death #divine 
**Trigger** Three or more sentient living creatures of 13th level or higher enter the haunt's area.
**Effect** The haunt deals `dice: 6d12+35` void damage to each creature in the haunt's area, and each creature must attempt a DC 40 will save.
