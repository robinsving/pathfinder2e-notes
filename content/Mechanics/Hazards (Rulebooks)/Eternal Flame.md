...
- **Critical Failure:** The creature is [[Sickened|Sickened 3]], and it is [[off-guard]] for as long as it remains within the haunt's area and for 3 rounds thereafter
***
**Routine** (1 action) Phantom flames rage across the haunted area, dealing `dice: 4d6` fire damage to each living creature within the area (DC 23 will save). Undead creatures in the area are infused with flames for the following round. They gain the fire trait and immunity to fire, and all their attacks deal an additional `dice: 1d6` fire damage. Objects in the area are unaffected.
***
