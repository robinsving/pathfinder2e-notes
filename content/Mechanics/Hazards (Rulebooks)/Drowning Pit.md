...
**Stealth** DC 10 (trained); DC 22 perception (expert) to notice the water spouts once the pit opens
...
***
**Disable** DC: 18 thievery (trained) to seal each water spout, DC: 22 thievery (trained) to open the trapdoor, or DC: 22 athletics to [[Force Open]] (Athletics) the trapdoor
___
**Pitfall** `pf2:r`
**Trigger** A creature walks onto the trapdoor
**Effect** The triggering creature falls in and takes damage from the fall, reduced by 5 feet for falling into the water (typically `dice: 12` bludgeoning damage). A creature can [[Grab an Edge]] to avoid falling. The trapdoor then slams shut, and the hazard rolls initiative.
***
