...
***
**Disable** DC 37 thievery{Thievery (master)} to jam a mannequin's clockwork mechanisms or a DC 35 religion{Religion (expert)} twice to exorcise a spirit from a mannequin.
___
**Awaken** `pf2:r`
...
___
**Clockwork Fist**: `pf2:1`
Strike 29 2d10 + 18 bludgeoning 
***
**Routine** Routine (9 actions) Each of the mannequins uses three of the haunt's actions on each turn, and the haunt loses three actions each turn for every disabled or destroyed mannequin. Each mannequin uses its first action to Stride up to 50 feet and its remaining two actions to make clockwork fist Strikes. Each has its own separate multiple attack penalty.
***
