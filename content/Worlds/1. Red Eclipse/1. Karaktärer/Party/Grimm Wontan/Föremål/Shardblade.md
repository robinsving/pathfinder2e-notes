...
# Egenskaper
>Shardblades är extremt skarpa och lätta att hantera, nästan utan tyngd. Trots sin storlek och kraft är de lätta att svänga och hantera med precision. När de aktiveras eller används, avger de ibland en svag aura eller ljus som omger bladet, vilket förstärker deras mystiska och magiska karaktär.
...
# Magiskt ursprung
>Deras ursprung är lindat i mystik och en del av deras natur är kopplad till de extraordinära krafter som finns i världen där de existerar. De har en koppling till en kosmisk kraft som ger dem dess unika egenskaper och kan ofta bara användas av utvalda individer.
